...
def admin_configuration_mta_sts(
    ...
    mta_sts_same_public_domain: str | None = Form(None),
    mta_sts_public_mail_domain: str = Form(""),
    mta_sts_public_dns_resolvers: str = Form(""),
    ...
    try:
        update_mta_sts_settings(
            ...
            same_public_domain=_form_bool(mta_sts_same_public_domain),
            public_mail_domain=mta_sts_public_mail_domain,
            public_dns_resolvers=mta_sts_public_dns_resolvers,
            mode=mta_sts_mode,
