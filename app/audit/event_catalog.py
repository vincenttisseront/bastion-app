...
_RAW_EVENTS: tuple[EventDef, ...] = (
    ...
    _e('BST-AUTH-2009', 'ACTIVESYNC_DEVICE_UNIDENTIFIED', 'Appareil ActiveSync non identifiable', ('authentication',),
       ...
       runbook="DeviceId non extractible : la requête est laissée passer tant que le contrôle par appareil est inactif. Regrouper par miss_family : 'decoder_failure' = corriger le décodeur MS-ASHTTP (lire miss_reason et query_sample) ; 'no_device_sent' = le client n'envoie pas de DeviceId et sera refusé dès l'activation du contrôle, l'identifier avant la bascule."),
