"""Export ModSecurity/CRS Phase B overlays (never overwrite Phase A static files).
...
def render_exclusions_generated(exclusions: list[WafExclusion]) -> str:
    lines = [
        "# Generated by nginx_waf_export — do not edit",
        "# Appended after includes/waf-basic.conf (manual Phase A exclusions stay intact).",
        "",
    ]
