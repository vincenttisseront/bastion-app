    ...
    *,
    ...
    return "\n".join(
        [
            ...
            # No access_log here: peer is always 127.0.0.1 (edge :443 → :8080).
            # Policy GETs are logged on the ACME edge (family=mta_sts) with real client IP.
            # Logging scanners (/favicon, /administrator/…) here would pollute Accès apps.
            "    access_log off;",
